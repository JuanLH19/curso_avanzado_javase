...
import com.juan.amazonviewer.model.Book;
import com.juan.amazonviewer.model.Chapter;
import com.juan.amazonviewer.model.Magazine;
import com.juan.amazonviewer.model.Movie;
import com.juan.amazonviewer.model.Serie;
import com.juan.makereport.Report;
import com.juan.util.AmazonUtil;
import com.juan.amazonviewer.model.*;



/**
 * <h1>Amazonviewer</h1>
 * Es un programa que permite visualizar Peliculas y series con sus respectivos capitulos.
 * Books y Magazines. Te permite generar reportes generales con fehca del día.
 * <p>
 * Existen algunas reglas como que todos los elementos pueden ser visualizados o leidos a excepción
